...
[
  ...
  wear            ;; keeps track of wear on patches of the road
]
...
to setup
  ...
  if (num-cars + num-trucks > count roads) [
    user-message (word
      "There are too many vehicles for the amount of "
      "road.  Either increase the amount of roads "
      "by increasing the GRID-SIZE-X or "
      "GRID-SIZE-Y sliders, or decrease the "
      "number of vehicles by lowering the NUM-CAR  and/or NUM-TRUCKS slider.\n"
  ...
  create-trucks num-trucks [
    setup-trucks
    set color brown ;; set truck color to brown
    set shape "truck"
    set size 2
    record-data
    ;; choose at random a location for the house
  ...
  ask turtles [
    set-car-speed
    set last-patch patch-here ;; initialize last-patch with the starting patch
  ]
...
to setup-patches
  ...
  ask patches [
    ...
    set wear 0 ;; initialize wear to 0 for all patches
  ]
